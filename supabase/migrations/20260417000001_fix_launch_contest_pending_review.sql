-- Fix: contests now enter pending_review instead of going directly active
...
BEGIN
  ...
  VALUES (_user_id, _title, _description, _category, _prize_first, COALESCE(_prize_second,0),
    ...
    _deadline, _required_skills, _visibility, _rules, _banner_image, _winner_selection_method, 'pending_review')
