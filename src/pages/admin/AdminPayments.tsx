        ...
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <ShieldAlert
                className={`h-5 w-5 ${withdrawalsFrozen ? "text-destructive" : "text-muted-foreground"}`}
              />
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  {withdrawalsFrozen
                    ? "Withdrawals are currently FROZEN. No user can withdraw."
                    : "Withdrawals are enabled for all users."}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <Label htmlFor="freeze-toggle" className="text-sm">
                {withdrawalsFrozen ? "Frozen" : "Active"}
              </Label>
              <Switch
                id="freeze-toggle"
                checked={withdrawalsFrozen}
                onCheckedChange={toggleWithdrawalFreeze}
