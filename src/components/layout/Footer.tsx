      ...
      <div className="container-wide section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-background/70">
              <li>
                <Link to="/freelancers" className="hover:text-primary transition-colors">
                  Find CAD Experts
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-background/70">
              <li>
                <Link to="/auth?tab=signup&role=freelancer" className="hover:text-primary transition-colors">
                  Become a Freelancer
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-background/70">
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:hello@cadnaija.com" className="hover:text-primary transition-colors">
                  hello@cadnaija.com
                </a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="mt-12 pt-8 border-t border-background/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-background/60">
            © {new Date().getFullYear()} CADNaija. All rights reserved.
          </p>
